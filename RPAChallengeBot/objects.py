...
class BrowserControl:
    ...
    def search_phrase(self, textToSearch):
        ...
        self.browser.click_button_when_visible("xpath://ps-header/header//button[@data-element='search-button']")
        self.browser.input_text_when_element_is_visible("xpath://ps-header/header//form[@data-element='search-form']//input[@data-element='search-form-input']", textToSearch)
        self.browser.click_button_when_visible("xpath://ps-header/header//form[@data-element='search-form']//button[@data-element='search-submit-button']")
